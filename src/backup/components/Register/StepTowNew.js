...
const StepTwoNew = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("aadhaar user not found in cookie");
    }
    ...
    try {
      ...
      if (primary_list_to_be_sent.length > 0) {
        ...
        // setssoUsername(primary_list_to_be_sent[0].userName);

        // if (primary_list_to_be_sent[0].userName) {
        //   setDisableUsername(true);
        //   setEdistrictCheck(true);
        // } else {
        //   setDisableUsername(false);
        // }
      }
    } catch (error) {
      console.warn("aadhaar user primary account list not found in cookie");
    }
    ...
    try {
      ...
      console.warn("aadhaar user secondary account list not found in cookie");
    }

    console.warn(umapArray, "Sadkhsadkjasdjkasdjkansd");
  }, []);
  ...
  return (
    <StepContainer>
      ...
      <Grid spacing={1} container>
        ...
        {/* <Grid item xs={4} md={mobileVerified ? 0 : 4} >
                    {!mobileVerified &&
                ...
                {otpSent && (
                    <>
                        <Grid item xs={4.5} md={6} mb={2}>
                            ...
                            <TextField sx={{ mb: 3, ...stylesCSS.input }} size="small" type="number" fullWidth label="Enter OTP" value={otp} placeholder="Enter OTP" variant="outlined" onChange={(e) => setOtp(e.target.value)} />
                        </Grid>
