    ...
    <StepContainer>
      <Grid spacing={2} container>
        ...
        {/* <Grid item xs={8} >
                    ...
                    <TextField disabled={emailVerified ? true : false} size="small" fullWidth label="Email" value={email} placeholder="Enter Email" variant="outlined" onChange={(e) => {
                        setEmail(e.target.value)
                        if (e.target.value.length === 10) {
                    ...
                    {emailVerified &&
                        <Stack direction="row" spacing={1} mt={1}>
                            <TaskAltIcon fontSize="small" color="success" />
                            <Typography color={"green"} style={{ fontSize: 12, marginLeft: 5 }}>Email is verified Successfully</Typography>
                        </Stack>
                    }
                    ...
                    {!emailVerified && otpSent &&
                        <Stack direction="row" spacing={1} mt={1}>
                            <TaskAltIcon fontSize="small" color="success" />
                            <Typography color={"green"} style={{ fontSize: 12, marginLeft: 5 }}>OTP sent to your Email Id : {email}</Typography>
                        </Stack>
                    }
                ...
                <Grid item xs={4} mb={2}>
                    <Button
                        ...
                        variant="contained"
                        color="success"
                        onClick={() => !otpSent ? sendEmailOtp() : verifyEmail()}
                    >
                        {"Get OTP"}
                    </Button>
                </Grid>
                ...
                {otpEmailSent && (
                    <>
                        <Grid item xs={6} mb={2}>
                            <TextField size="small" type="number" fullWidth label="Enter OTP" value={emailOtp} placeholder="Enter OTP" variant="outlined" onChange={(e) => setEmailOtp(e.target.value)} />
                        </Grid>


                        <Grid item xs={6}>

                            <Stack direction="row" spacing={1} mt={0.5} justifyContent={"right"} alignContent={"right"} >
                                {emailVerified ? null : <Button
                                    fullWidth
                                    style={{ fontSize: '0.7rem', padding: '4px 8px' }}
                                    variant="contained"
                                    color="success"
                                    onClick={() => !otpEmailSent ? sendEmailOtp() : verifyEmail()}
                                >
                                    {otpEmailSent ? "Verify" : "Generate OTP"}
                                </Button>}
        ...
        {/*
                ...
                <Grid item xs={otpEmailSent ? (emailVerified ? 12 : 4) : 6} mb={2}>
                    <TextField disabled={emailVerified ? true : false} size="small" fullWidth label="Email ID" value={email} placeholder="Enter Email ID" variant="outlined" onChange={(e) => {
                        setEmail(e.target.value)
                        if (e.target.value.length === 10) {
                ...
                <>
                    ...
                    <Grid item xs={otpEmailSent ? 3 : 0} mb={2}>
                        {otpEmailSent && (
                            <TextField size="small" type="number" fullWidth label="Enter OTP" value={otp} placeholder="Enter OTP" variant="outlined" onChange={(e) => setOtp(e.target.value)} />
                        )}
                    </Grid>
                    ...
                    <Grid item xs={5} mb={2}>
                        ...
                        <Stack direction="row" spacing={1} mt={0.5} justifyContent={"right"} alignContent={"right"} >
                            {emailVerified ? null : <Button
                                ...
                                onClick={() => !otpEmailSent ? sendEmailOtp() : verifyEmail()}
                            >
                                {otpEmailSent ? "Verify OTP" : "Generate OTP"}
                            </Button>}
