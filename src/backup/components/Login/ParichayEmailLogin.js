...
const ParichayEmailLogin = ({ handleChange }) => {
    ...
    const sendOtp = async () => {
        ...
        if (userName) {
            ...
            setAlert({ open: true, type: false, message: "Please enter valid Email or Username" });
        }
    ...
    return (
        <>
            <Grid spacing={2} container>
                <Grid item xs={12}>
                    <TextField size="small" focused required error={error.username && true} value={userName} onChange={
                        (e) => {
                ...
                {loginWithOtp ? (
                    <Grid item xs={12}>
                        ...
                        <TextField size="small" focused helperText="OTP sent to your email address." required error={error.otp && true} onChange={(e) => setOTP(e.target.value)} value={otp} fullWidth label="OTP" variant="outlined" />
                    </Grid>
                ) : (
                    <Grid item xs={12}>
                        ...
                        <FormControl size="small" focused variant="outlined" sx={{ width: '100%' }}>
                            <InputLabel size="small"
                                focused htmlFor="outlined-adornment-password">Password</InputLabel>
                            <OutlinedInput
