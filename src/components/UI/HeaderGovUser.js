...
const HeaderGovUser = () => {
	...
	const logOut = () => {
		...
		window.location.href =
			"https://sso.hp.gov.in/official/site/logout?onboardingapp=himparivarsso";
				...
				>
					...
					<List>
						<ListItem
							...
							button
							sx={{
								backgroundColor: route.pathname === "/dashboard" && "#09539d",
							}}
						>
							<ListItemIcon>
						...
						<ListItem
							onClick={() => route.push("/transaction-history")}
							button
							sx={{
								backgroundColor:
									route.pathname === "/transaction-history" && "#09539d",
							}}
						>
							<ListItemIcon>
