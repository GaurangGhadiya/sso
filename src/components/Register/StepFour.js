			...
			<Grid spacing={3} container>
				...
				<Grid item xs={12}>
					<Stack direction="row" spacing={1}>
						<TextField
							onChange={(e) => !mobileVerified && setMobile(e.target.value)}
							value={mobile}
							helperText={
								<span
									style={{ color: `${mobileVerifiedStep ? "green" : "red"}` }}
								>
									Mobile Number is {!mobileVerified && "Not"} Verified
								</span>
							}
							required
							fullWidth
