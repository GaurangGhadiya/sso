		...
		<StepContainer loading={loading}>
			...
			{!skipAadhaar && (
				<Box>
								...
								<Stack direction="row" spacing={0} alignItems="flex-start">
									...
									<div style={{ maxHeight: "100px", overflowY: "auto" }}>
										<Typography mt={2} style={{ flex: 1, fontSize: 12 }}>
											...
											I hereby give my consent to Government of Himachal Pradesh
											for fetching my identity and other information for purpose
											of e-KYC through UIDAI, using the Aadhaar OTP or Biometric
											authentication with UIDAI and seeding it with family data
											base (Him Parivar), Government of Himachal Pradesh and
											Him Access  which is an
											integral part of Him Parivar. I also give my consent for
											using my Aadhaar Number for disbursement of benefits
											through DBT for the Government Welfare Scheme notified
											under section 7 of Aadhaar Act. The consent and purpose of
											collecting Aadhaar has been explained to me in local
											language. The department has informed me that my Aadhaar
											shall not be used for any purpose other than mentioned
											above.
											<br />
											...
											that specific transaction and for no other purposes.
											<br />
											Further, I hereby give my consent to use my personal data
											available with various departments of State and Central
											for creating the family database of Government of
											Himachal. I am aware that this database shall be used for
											deciding my eligibility for various schemes, service and
					...
					>
						<Typography style={{ fontSize: 12 }}>
							I dont want to give Aadhaar Number
						</Typography>
						<Typography
							onClick={() => setskipAadhaar(true)}
				...
				<Grid container>
					...
					<Box sx={{ display: "flex", justifyContent: "flex-end" }}>
						<Stack
							...
							alignItems={"flex-end"}
						>
							<Button variant="text" onClick={() => setskipAadhaar(false)}>
								Back
							</Button>
